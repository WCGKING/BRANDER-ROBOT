...
class Config(object):
    ...
    OWNER_USERNAME = "BRANDRDR_BOT"
    SUPPORT_CHAT = "BRANDRDR_BOT"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001626004802
    ...
    MONGO_DB_URI= "mongodb+srv://Musicbot58:93529352@cluster0.n6wscri.mongodb.net/?retryWrites=true&w=majority"
    # RECOMMENDED
    ...
    DRAGONS = get_user_list("elevated_users.json", "6258877205)
    ##List of id's - (not usernames) for developers who will have the same perms as the owner
    DEV_USERS = get_user_list("elevated_users.json", "6258877205)
    ##List of id's (not usernames) for users which are allowed to gban, but can also be banned.
    DEMONS = get_user_list("elevated_users.json", "6258877205)
    # List of id's (not usernames) for users which WONT be banned/kicked by the bot.
    TIGERS = get_user_list("elevated_users.json", "6258877205)
    WOLVES = get_user_list("elevated_users.json", "whitelists")
    DONATION_LINK = "https://t.me/BRANDRD_BOT" # EG, paypal
    CERT_PATH = None
    PORT = 5000
